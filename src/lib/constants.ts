...
const DASHBOARD_NAV_BY_ROLE: Record<StaffRole, NavItem[]> = {
  owner: [
    ...
    { title: "nav.kitchen", href: ROUTES.KITCHEN, icon: "ChefHat" },
    { title: "nav.waiter", href: ROUTES.WAITER, icon: "Serving" },
    ...
    { title: "nav.performance", href: ROUTES.PERFORMANCE, icon: "ChartBar" },
  ...
  kitchen_staff: [{ title: "nav.kitchen", href: ROUTES.KITCHEN, icon: "ChefHat" }],
  waiter: [{ title: "nav.waiter", href: ROUTES.WAITER, icon: "Serving" }],
};
